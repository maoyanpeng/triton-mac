...
void init_triton_passes_convert(py::module &&m) {
  ...
  ADD_PASS_WRAPPER_0("add_arith_to_emitc", triton::createArithToEmitcConversionPass);
  ADD_PASS_WRAPPER_0("add_triton_to_emitc", triton::createTritonToEmitcConversionPass);

...
// void init_triton_mac_passes_ttgpuir(py::module &&m) {
...
// void init_triton_mac_passes_ttnvgpuir(py::module &&m) {
...
void init_triton_mac(py::module &&m) {
  // auto passes = m.def_submodule("passes");
  // init_triton_mac_passes_ttgpuir(passes.def_submodule("ttgpuir"));
  // init_triton_mac_passes_ttnvgpuir(passes.def_submodule("ttnvgpuir"));
